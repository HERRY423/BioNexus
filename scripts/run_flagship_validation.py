...
def _build_limitations(capability: str, dataset_id: str) -> List[str]:
    """Build honest limitation notes for a skipped capability."""
...
def run_single_capability(
    ...
    # Limitations
    limitations = _build_limitations(capability, dataset_id)
