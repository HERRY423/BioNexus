...
**Timestamp**: `2026-09-04T11:49:00.343888+00:00` | **Gating Cases**: `84` | **Passed**: `84` | **Failed**: `0` | **Skipped (backend unavailable)**: `0` | **Gating Accuracy (attempted)**: `100.0%`
**Union (gating + frontier)**: `98` cases | **Union Accuracy**: `100.0%` (the honest number, BNS-LC-006)
...
- **Union Accuracy (gating + frontier)**: `98/98` = `100.0%`
...
- **Verdict**: `CALIBRATED`
- **Exact Accuracy**: `100.0%` | **OCE**: `0.000` | **Macro-F1**: `100.0%`
