...
ALIGNMENTS: Dict[str, StandardAlignment] = {
    ...
    for a in [
        ...
        StandardAlignment(
            key="ga4gh-drs",
            name="GA4GH Data Repository Service (DRS v1.2.0)",
            url="https://ga4gh.github.io/data-repository-service-schemas/",
            status="implemented",
            role="Data object access, content-based checksums, and access URLs for multi-cloud genomics",
            since="0.11.0",
            verification="repository_tested",
        ),
        StandardAlignment(
            key="ga4gh-tes",
            name="GA4GH Task Execution Service (TES v1.0.0)",
            url="https://ga4gh.github.io/task-execution-schemas/",
            status="implemented",
            role="Containerized batch task descriptions with elastic scale policies",
            since="0.11.0",
            verification="repository_tested",
        ),
        StandardAlignment(
            key="phenopackets",
            name="GA4GH Phenopackets v2",
            url="https://phenopackets-schema.readthedocs.io/en/latest/",
            status="implemented",
            role="Phenotypic, disease, and individual donor descriptions mapped to ontologies (HPO/MONDO)",
            since="0.11.0",
            verification="repository_tested",
        ),
        StandardAlignment(
