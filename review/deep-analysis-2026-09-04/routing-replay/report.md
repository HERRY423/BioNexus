...
**Selection**: suite=`all`, level=`all`, excluded suites=`['flagship_validation', 'l3_scientific_outcomes']`. Scores cover this selection only.
...
**Timestamp**: `2026-09-04T09:42:37.852378+00:00` | **Gating Cases**: `79` | **Passed**: `79` | **Failed**: `0` | **Skipped (backend unavailable)**: `0` | **Gating Accuracy (attempted)**: `100.0%`
**Union (gating + frontier)**: `93` cases | **Union Accuracy**: `94.6%` (the honest number, BNS-LC-006)
...
| **L3** | L3: Scientific Outcome & Ground Truth | 0 | 0 | 0 | 0 | `0.0%` |
...
- **Frontier Cases**: `14` | **Passed**: `9` | **Failed**: `5` | **Pass Rate**: `64.3%`
- **Union Accuracy (gating + frontier)**: `88/93` = `94.6%`
...
- **`frontier-coordinate-umap-substitution-001`** [L1/scientific_semantics]
  - Status mismatch: Expected ABSTAIN, got PERMITTED (Rationale: Scientific preconditions, input semantics, and backend for 'scrna.exploratory_clustering' are fully satisfied. Purpose: exploratory; evidence ceiling: PRELIMINARY.)
...
- **`frontier-insufficient-power-clustering-002`** [L1/scientific_semantics]
  - Status mismatch: Expected DEGRADED_ADVISORY, got PERMITTED (Rationale: Scientific preconditions, input semantics, and backend for 'scrna.exploratory_clustering' are fully satisfied. Purpose: unspecified; evidence ceiling: FRAGILE. Research purpose is UNSPECIFIED: conclusions are capped at FRAGILE until a purpose (exploratory / screening / confirmatory / causal / clinical) is explicitly declared.)
