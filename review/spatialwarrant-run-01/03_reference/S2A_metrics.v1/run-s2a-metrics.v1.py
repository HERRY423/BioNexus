...
def main() -> None:
    ...
    write_bytes_exclusive("run-s2a-metrics.v1.py", pathlib.Path(__file__).read_bytes())
    ...
    write_json_exclusive(
        "mitochondrial-feature-mask.v1.json",
        {
            ...
            "members": [
                {"feature_index_1_based": i + 1, "gene_symbol": genes[i]}
