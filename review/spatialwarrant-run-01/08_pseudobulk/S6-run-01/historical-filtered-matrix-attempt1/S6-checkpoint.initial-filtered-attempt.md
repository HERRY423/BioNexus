...
- CID4535 region eligibility: B1 49 spots/772,649 UMI; B2 94 spots/1,372,908 UMI; B3 145 spots/2,117,438 UMI; core 273 spots/4,097,065 UMI.
- Frozen IFN program coverage: 195/200; missing: KLRK1, MARCHF1, RIGI, TMT1B, WARS1.
- Primary B2 boundary − core: 0.063654035 mean log2(CPM+1). Sensitivities: B1 0.029519092; B3 0.026377980.
...
- External evidence: 168/180 successful source calls after source-wrapper repair; 12 true failures retained. Returned context remains UNASSESSED.
- BioNexus: provenance sidecars and seven passive envelope audits completed; MCP host probe failed validation once and then timed out, so no MCP receipt is claimed.
- Peak measured process memory: 9,827,737,600 bytes. Start/end C free: 32,392,167,424/32,280,973,312 bytes. Combined S6 output: 32,195,744 bytes.
