...
本页对应 rc7 开发线的软件合同，不证明外部研究已完成。首个产品范围仍是：被动审阅已经完成的多供体单细胞 DE 结果，支持有姓名的研究者作出判断。外部任务增益、实验室采用、独立专家结论均需实际数据，软件检查不证明其中任何一项。Core 1.0 的受支持范围与维护激活以 `GA_CRITERIA.md` 和 `MAINTENANCE.md` 为准。
