...
**Timestamp**: `2026-08-16T07:50:19.534429+00:00` | **Gating Cases**: `42` | **Gating Accuracy**: `100.0%`
**Union (gating + frontier)**: `53` cases | **Union Accuracy**: `92.5%` (the honest number, BNS-LC-006)
**Execution Mode**: `OFFLINE TRACE REPLAY` | **Host Provider**: `auto` | **Model**: `simulated_trace_v1`

## Multi-Tier Benchmark Levels

| Tier Level | Evaluation Scope | Total | Passed | Failed | Accuracy |
|---|---|---|---|---|---|
| **L1** | L1: Router & Precondition Regression | 32 | 32 | 0 | `100.0%` |
| **L2** | L2: Host-Agent Prohibited Claims Audit | 6 | 6 | 0 | `100.0%` |
| **L3** | L3: Scientific Outcome & Ground Truth | 4 | 4 | 0 | `100.0%` |
...
- **Cases Evaluated**: `38` (calibration claims are only valid over stated case counts, BNS-EM-009)
...
- **Exact Accuracy**: `95.9%` | **OCE**: `0.041` | **Macro-F1**: `96.3%`
- **Overconfidence**: `0.0%` | **Underconfidence**: `2.0%`
