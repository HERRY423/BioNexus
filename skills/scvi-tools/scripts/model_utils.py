...
def train_scvi(
    ...
    batch_size : int, optional
        Mini-batch size (auto-scaled: 128 for <50k cells, 512 for 100k+ cells)
    precision : str, optional
        Precision mode ('16-mixed', 'bf16-mixed', or '32')
    num_workers : int
        Number of subprocesses for data loading (default: 0)
    early_stopping_patience : int
        Patience epochs for early stopping (default: 15)
    ...
    trainer_kwargs = {}
    if precision and precision in ("16-mixed", "bf16-mixed", "16", "32"):
