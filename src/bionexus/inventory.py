...
SKILLS: List[SkillRecord] = [
    {
        ...
        "tier": "outline",
        "status": "canonical",
        "does": "Orient the agent: inventory, local fallback vs peer capabilities, capability grades.",
    ...
    },
    {
        ...
        "tier": "wrapper",
        "status": "canonical",
        "does": "Validate content-bound results supplied by external literature, database, analysis, sequence, structure, or slide capabilities.",
        "does_not": "Select or invoke another tool; authenticate a declared producer; or promote retrieval into independent validation.",
        "backend": "bionexus.ecosystem_intake",
    },
    {
