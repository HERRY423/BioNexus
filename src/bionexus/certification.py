...
_EVIDENCE: Dict[str, Dict[str, tuple[bool, str, str]]] = {
    ...
    "scrna.annotation_evidence": {
        ...
        "public_reference_dataset": (False, "validation/annotation/REPORT.json -> synthetic technical acceptance; no real CITE-seq dataset vendored or executed", "Synthetic technical acceptance does not satisfy public reference dataset"),
        "independent_ground_truth": (False, "Synthetic fixture truth generated alongside test; no independent ground truth dataset executed", "Independent ground truth requires external truth independent of synthetic simulation"),
    ...
    "spatial.inference_validity": {
        ...
        "adversarial_test": (True, "evals/spatial_stress_test.py::test_dim2_segmentation_leakage (adversarial artifact detection)", ""),
        "public_reference_dataset": (False, "validation/spatial/REPORT.json -> synthetic technical acceptance; no real Xenium/MERSCOPE dataset vendored or executed", "Synthetic technical acceptance does not satisfy public reference dataset"),
        "independent_ground_truth": (False, "Synthetic permutation/distance truth generated alongside test; no independent ground truth dataset executed", "Independent ground truth requires external truth independent of synthetic simulation"),
        "parameter_perturbation": (True, "evals/spatial_stress_test.py::test_dim7_radius_sensitivity (neighborhood radius sweep 15-100um)", ""),
        "degradation_test": (True, "evals/spatial_stress_test.py::test_dim1_baseline (no-controls -> ABSTAIN/NEEDS_DATA)", ""),
        "provenance_test": (True, "tests/unit/test_provenance_tracker.py, tests/unit/test_validation_artifacts.py", ""),
        "cross_host_test": (False, "cross-host/COMPARISON.json (framework: codex + claude-code; 0 traps compared)", "Cross-host framework established but no L2 claim audit executed"),
