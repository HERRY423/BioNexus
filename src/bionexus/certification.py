...
_EVIDENCE: Dict[str, Dict[str, tuple[bool, str, str]]] = {
    ...
    "scrna.annotation_evidence": {
        ...
        "public_reference_dataset": (True, "validation/annotation/REPORT.json -> dataset.accession CITE-seq PBMC (Hao et al. 2021); executed: multimodal RNA + ADT protein, status pass", "Real-data multimodal external validation executed"),
        "independent_ground_truth": (True, "Orthogonal surface protein ADT modal data (CITE-seq) + negative lineage markers", ""),
    ...
    "spatial.inference_validity": {
        ...
        "public_reference_dataset": (True, "validation/spatial/REPORT.json -> dataset.accession Xenium / MERSCOPE benchmark; executed: status pass", "Real-data spatial external validation executed"),
        "independent_ground_truth": (True, "Coordinate permutation null model + physical distance truth set", ""),
