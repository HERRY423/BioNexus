...
_EVIDENCE: Dict[str, Dict[str, tuple[bool, str, str]]] = {
    "scrna.pseudobulk_de": {
        ...
        "public_reference_dataset": (False, "validation/pseudobulk/REPORT.json -> dataset.accession GSE96583 (Kang et al. 2018); dataset not locally available, validation skipped", "Target public dataset recorded but not executed; status 'skipped'"),
        ...
        "cross_host_test": (False, "cross-host/COMPARISON.json (framework: codex + claude-code; 0 traps compared, agreement_rate null)", "Cross-host framework established but no L2 claim audit executed"),
        "external_reviewer": (False, "review/SCIENTIFIC_REVIEW.json (3 reviewer slots; all PENDING; status framework_created_pending_review)", "Scientific review framework established but no review conducted"),
    },
    ...
    "scrna.annotation_evidence": {
        ...
        "public_reference_dataset": (False, "validation/annotation/REPORT.json -> dataset.accession CITE-seq PBMC (Hao et al. 2021); dataset not locally available, validation skipped", "Target public dataset recorded but not executed"),
    ...
    "spatial.inference_validity": {
        ...
        "public_reference_dataset": (False, "validation/spatial/REPORT.json -> dataset.accession Xenium/MERSCOPE; dataset not locally available, validation skipped", "Target public dataset recorded but not executed"),
