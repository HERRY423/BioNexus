...
_EVIDENCE: Dict[str, Dict[str, tuple[bool, str, str]]] = {
    ...
    "spatial.inference_validity": {
        ...
        "public_reference_dataset": (False, "validation/spatial/REPORT.json -> synthetic technical acceptance; no real Xenium/CosMx/MERSCOPE dataset executed", "Synthetic technical acceptance does not satisfy public reference dataset"),
